...
class Relax_Template extends Classes\Template {
				...
				<div class="main-div">
					...
					<div class="container">
						...
						<div style="max-width:700px;">
							...
							<div class="text-left mx-auto m-4">
							...
							<div class="my-4 text-center text-md-left mx-auto mx-md-0">
							
								<?php $this->print_store_links();?>

							</div>

							<div class="my-4 mx-auto mx-md-0" style="max-width: 400px;">
