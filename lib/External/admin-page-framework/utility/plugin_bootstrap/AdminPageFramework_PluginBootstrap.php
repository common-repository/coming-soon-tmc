...
abstract class cs_tmc_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('cs_tmc_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new cs_tmc_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
