...
abstract class cs_tmc_AdminPageFramework_UserMeta_Router extends cs_tmc_AdminPageFramework_Factory {
...
abstract class cs_tmc_AdminPageFramework_UserMeta_Model extends cs_tmc_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new cs_tmc_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class cs_tmc_AdminPageFramework_UserMeta_View extends cs_tmc_AdminPageFramework_UserMeta_Model {
...
abstract class cs_tmc_AdminPageFramework_UserMeta_Controller extends cs_tmc_AdminPageFramework_UserMeta_View {
...
abstract class cs_tmc_AdminPageFramework_UserMeta extends cs_tmc_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'cs-tmc') {
