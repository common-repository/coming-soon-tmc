...
abstract class cs_tmc_AdminPageFramework_Widget_Router extends cs_tmc_AdminPageFramework_Factory {
...
abstract class cs_tmc_AdminPageFramework_Widget_Model extends cs_tmc_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new cs_tmc_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class cs_tmc_AdminPageFramework_Widget_View extends cs_tmc_AdminPageFramework_Widget_Model {
...
abstract class cs_tmc_AdminPageFramework_Widget_Controller extends cs_tmc_AdminPageFramework_Widget_View {
...
abstract class cs_tmc_AdminPageFramework_Widget extends cs_tmc_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'cs-tmc') {
