...
abstract class cs_tmc_AdminPageFramework_MetaBox_Router extends cs_tmc_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'cs-tmc') {
...
abstract class cs_tmc_AdminPageFramework_MetaBox_Model extends cs_tmc_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'cs-tmc') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new cs_tmc_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class cs_tmc_AdminPageFramework_MetaBox_View extends cs_tmc_AdminPageFramework_MetaBox_Model {
...
abstract class cs_tmc_AdminPageFramework_MetaBox_Controller extends cs_tmc_AdminPageFramework_MetaBox_View {
...
abstract class cs_tmc_AdminPageFramework_MetaBox extends cs_tmc_AdminPageFramework_MetaBox_Controller {
