...
class cs_tmc_AdminPageFramework_Property_post_meta_box extends cs_tmc_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'cs-tmc', $sStructureType = 'post_meta_box') {
