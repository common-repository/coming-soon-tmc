...
class cs_tmc_AdminPageFramework_Debug_Base extends cs_tmc_AdminPageFramework_FrameworkUtility {
...
class cs_tmc_AdminPageFramework_Debug_Log extends cs_tmc_AdminPageFramework_Debug_Base {
...
class cs_tmc_AdminPageFramework_Debug extends cs_tmc_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('cs_tmc_AdminPageFramework_Debug::' . __FUNCTION__, 'cs_tmc_AdminPageFramework_Debug::dump()');
        cs_tmc_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('cs_tmc_AdminPageFramework_Debug::' . __FUNCTION__, 'cs_tmc_AdminPageFramework_Debug::get()');
        return cs_tmc_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('cs_tmc_AdminPageFramework_Debug::' . __FUNCTION__, 'cs_tmc_AdminPageFramework_Debug::log()');
        cs_tmc_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('cs_tmc_AdminPageFramework_Debug::' . __FUNCTION__);
