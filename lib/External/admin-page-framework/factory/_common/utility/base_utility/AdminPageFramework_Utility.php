...
abstract class cs_tmc_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        cs_tmc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return cs_tmc_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        cs_tmc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return cs_tmc_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        cs_tmc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        cs_tmc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        cs_tmc_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'cs_tmc_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class cs_tmc_AdminPageFramework_Utility_VariableType extends cs_tmc_AdminPageFramework_Utility_Deprecated {
...
abstract class cs_tmc_AdminPageFramework_Utility_String extends cs_tmc_AdminPageFramework_Utility_VariableType {
...
abstract class cs_tmc_AdminPageFramework_Utility_Array extends cs_tmc_AdminPageFramework_Utility_String {
...
abstract class cs_tmc_AdminPageFramework_Utility_ArrayGetter extends cs_tmc_AdminPageFramework_Utility_Array {
...
abstract class cs_tmc_AdminPageFramework_Utility_ArraySetter extends cs_tmc_AdminPageFramework_Utility_ArrayGetter {
...
abstract class cs_tmc_AdminPageFramework_Utility_Path extends cs_tmc_AdminPageFramework_Utility_ArraySetter {
...
abstract class cs_tmc_AdminPageFramework_Utility_URL extends cs_tmc_AdminPageFramework_Utility_Path {
...
abstract class cs_tmc_AdminPageFramework_Utility_File extends cs_tmc_AdminPageFramework_Utility_URL {
...
abstract class cs_tmc_AdminPageFramework_Utility_SystemInformation extends cs_tmc_AdminPageFramework_Utility_File {
...
abstract class cs_tmc_AdminPageFramework_Utility_HTMLAttribute extends cs_tmc_AdminPageFramework_Utility_SystemInformation {
...
class cs_tmc_AdminPageFramework_Utility extends cs_tmc_AdminPageFramework_Utility_HTMLAttribute {
