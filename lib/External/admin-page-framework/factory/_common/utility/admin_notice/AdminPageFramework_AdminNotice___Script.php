...
class cs_tmc_AdminPageFramework_AdminNotice___Script extends cs_tmc_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.cs-tmc-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='cs-tmc-admin-notice-animation-container'></div>" );
