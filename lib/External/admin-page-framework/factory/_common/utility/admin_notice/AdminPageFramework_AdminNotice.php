...
class cs_tmc_AdminPageFramework_AdminNotice extends cs_tmc_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'cs-tmc-settings-notice-message', 'cs-tmc-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new cs_tmc_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
