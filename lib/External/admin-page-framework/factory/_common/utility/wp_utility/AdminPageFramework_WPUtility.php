...
class cs_tmc_AdminPageFramework_WPUtility_URL extends cs_tmc_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(cs_tmc_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(cs_tmc_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = cs_tmc_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class cs_tmc_AdminPageFramework_WPUtility_HTML extends cs_tmc_AdminPageFramework_WPUtility_URL {
...
class cs_tmc_AdminPageFramework_WPUtility_Page extends cs_tmc_AdminPageFramework_WPUtility_HTML {
...
class cs_tmc_AdminPageFramework_WPUtility_Hook extends cs_tmc_AdminPageFramework_WPUtility_Page {
...
class cs_tmc_AdminPageFramework_WPUtility_File extends cs_tmc_AdminPageFramework_WPUtility_Hook {
...
class cs_tmc_AdminPageFramework_WPUtility_Option extends cs_tmc_AdminPageFramework_WPUtility_File {
...
class cs_tmc_AdminPageFramework_WPUtility_Meta extends cs_tmc_AdminPageFramework_WPUtility_Option {
...
class cs_tmc_AdminPageFramework_WPUtility_SiteInformation extends cs_tmc_AdminPageFramework_WPUtility_Meta {
...
class cs_tmc_AdminPageFramework_WPUtility_SystemInformation extends cs_tmc_AdminPageFramework_WPUtility_SiteInformation {
...
class cs_tmc_AdminPageFramework_WPUtility extends cs_tmc_AdminPageFramework_WPUtility_SystemInformation {
