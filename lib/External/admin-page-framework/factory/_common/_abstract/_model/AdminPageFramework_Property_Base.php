...
abstract class cs_tmc_AdminPageFramework_Property_Base extends cs_tmc_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'cs-tmc' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['acs_tmc_AdminPageFramework'])) {
            $GLOBALS['acs_tmc_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => cs_tmc_AdminPageFramework_Registry::NAME, 'sURI' => cs_tmc_AdminPageFramework_Registry::URI, 'sScriptName' => cs_tmc_AdminPageFramework_Registry::NAME, 'sLibraryName' => cs_tmc_AdminPageFramework_Registry::NAME, 'sLibraryURI' => cs_tmc_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => cs_tmc_AdminPageFramework_Registry::getVersion(), 'sDescription' => cs_tmc_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => cs_tmc_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => cs_tmc_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => cs_tmc_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => cs_tmc_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new cs_tmc_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
