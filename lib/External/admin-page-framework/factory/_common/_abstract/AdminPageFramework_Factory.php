...
abstract class cs_tmc_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'cs_tmc_AdminPageFramework_Form_', 'oPageLoadInfo' => 'cs_tmc_AdminPageFramework_PageLoadInfo_', 'oResource' => 'cs_tmc_AdminPageFramework_Resource_', 'oHelpPane' => 'cs_tmc_AdminPageFramework_HelpPane_', 'oLink' => 'cs_tmc_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'cs_tmc_AdminPageFramework_Debug', 'oUtil' => 'cs_tmc_AdminPageFramework_FrameworkUtility', 'oMsg' => 'cs_tmc_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(cs_tmc_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return cs_tmc_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class cs_tmc_AdminPageFramework_Factory_Model extends cs_tmc_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class cs_tmc_AdminPageFramework_Factory_View extends cs_tmc_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new cs_tmc_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class cs_tmc_AdminPageFramework_Factory_Controller extends cs_tmc_AdminPageFramework_Factory_View {
...
abstract class cs_tmc_AdminPageFramework_Factory extends cs_tmc_AdminPageFramework_Factory_Controller {
}
