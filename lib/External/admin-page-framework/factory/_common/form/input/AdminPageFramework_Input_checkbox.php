...
abstract class cs_tmc_AdminPageFramework_Input_Base extends cs_tmc_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'cs-tmc-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'cs-tmc-input-label-string',),);
...
class cs_tmc_AdminPageFramework_Input_checkbox extends cs_tmc_AdminPageFramework_Input_Base {
