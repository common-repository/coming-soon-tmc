...
class cs_tmc_AdminPageFramework_FieldType_submit extends cs_tmc_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".cs-tmc-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'cs-tmc-input-label-container' . ' cs-tmc-input-button-container' . ' cs-tmc-input-container',);
    }
...
class cs_tmc_AdminPageFramework_FieldType_export extends cs_tmc_AdminPageFramework_FieldType_submit {
