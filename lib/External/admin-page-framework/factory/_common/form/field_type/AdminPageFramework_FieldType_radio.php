...
class cs_tmc_AdminPageFramework_FieldType_radio extends cs_tmc_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".cs-tmc-field input[type='radio'] {margin-right: 0.5em;} .cs-tmc-field-radio .cs-tmc-input-label-container {padding-right: 1em;} .cs-tmc-field-radio .cs-tmc-input-container {display: inline;} .cs-tmc-field-radio .cs-tmc-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.cs-tmc-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
