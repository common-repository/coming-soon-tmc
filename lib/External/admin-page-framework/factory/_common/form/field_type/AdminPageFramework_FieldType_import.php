...
class cs_tmc_AdminPageFramework_FieldType_import extends cs_tmc_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".cs-tmc-field-import input {margin-right: 0.5em;}.cs-tmc-field-import label,.form-table td fieldset.cs-tmc-fieldset .cs-tmc-field-import label { display: inline; }";
    }
