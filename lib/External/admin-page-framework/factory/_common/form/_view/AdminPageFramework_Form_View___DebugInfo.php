...
class cs_tmc_AdminPageFramework_Form_View___DebugInfo extends cs_tmc_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='cs-tmc-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
