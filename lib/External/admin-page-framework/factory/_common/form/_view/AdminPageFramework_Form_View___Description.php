...
class cs_tmc_AdminPageFramework_Form_View___Description extends cs_tmc_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'cs-tmc-form-element-description';
