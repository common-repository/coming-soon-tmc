...
class cs_tmc_AdminPageFramework_Form_View___Script_Form extends cs_tmc_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removecs_tmc_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.cs-tmc-form-loading' ).remove();
        jQuery( '.cs-tmc-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.cs-tmc-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removecs_tmc_AdminPageFrameworkLoadingOutputs();
