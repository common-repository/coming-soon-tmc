...
class cs_tmc_AdminPageFramework_Form_View___Script_SectionTab extends cs_tmc_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.cs-tmc-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='cs-tmc-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
