...
class cs_tmc_AdminPageFramework_Form_View___Script_MediaUploader extends cs_tmc_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getcs_tmc_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
