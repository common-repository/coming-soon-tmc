...
class cs_tmc_AdminPageFramework_Form_View___Script_SortableField extends cs_tmc_AdminPageFramework_Form_View___Script_Base {
    ...
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablecs_tmc_AdminPageFrameworkSortableFields = function( sFieldsContainerID ) {
...
class cs_tmc_AdminPageFramework_Form_View___Script_SortableSection extends cs_tmc_AdminPageFramework_Form_View___Script_SortableField {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablecs_tmc_AdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'cs-tmc-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.cs-tmc-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.cs-tmc-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .cs-tmc-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.cs-tmc-section-caption'
                    : false,
                ...
                stop: function(e,ui) {
                    ...
                    jQuery( this ).trigger( 
                        'cs-tmc_stopped_sorting_sections', 
                ...
                // cancel: '.cs-tmc-section-description, .cs-tmc-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .cs-tmc-section-title:not(.cs-tmc-collapsible-sections-title,.cs-tmc-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .cs-tmc-section-title:not(.cs-tmc-collapsible-sections-title,.cs-tmc-collapsible-section-title)' ).not( ':first' ).hide();
...
jQuery( document ).ready( function() {    
    jQuery( '#{$sContainerTagID}' ).enablecs_tmc_AdminPageFrameworkSortableSections( '{$sContainerTagID}' ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='cs-tmc-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
