...
class cs_tmc_AdminPageFramework_Form_View___Script_Widget extends cs_tmc_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.cs-tmc-sectionset' ).length <= 0 ) { 
                    return; 
                }   
