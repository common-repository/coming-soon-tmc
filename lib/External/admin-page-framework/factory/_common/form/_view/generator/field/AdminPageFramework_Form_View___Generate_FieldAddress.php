...
abstract class cs_tmc_AdminPageFramework_Form_View___Generate_Field_Base extends cs_tmc_AdminPageFramework_Form_View___Generate_Section_Base {
...
class cs_tmc_AdminPageFramework_Form_View___Generate_FieldName extends cs_tmc_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class cs_tmc_AdminPageFramework_Form_View___Generate_FlatFieldName extends cs_tmc_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class cs_tmc_AdminPageFramework_Form_View___Generate_FieldAddress extends cs_tmc_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
