...
class cs_tmc_AdminPageFramework_Form_View___Generate_FieldTagID extends cs_tmc_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class cs_tmc_AdminPageFramework_Form_View___Generate_FieldInputID extends cs_tmc_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
