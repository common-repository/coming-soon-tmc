...
class cs_tmc_AdminPageFramework_Form_Model___Format_RepeatableSection extends cs_tmc_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : cs_tmc_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class cs_tmc_AdminPageFramework_Form_Model___Format_RepeatableField extends cs_tmc_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
