...
class cs_tmc_AdminPageFramework_Form_Model___SetFieldResources extends cs_tmc_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new cs_tmc_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('cs_tmc_AdminPageFramework_Form_View___CSS_Form', 'cs_tmc_AdminPageFramework_Form_View___CSS_Field', 'cs_tmc_AdminPageFramework_Form_View___CSS_Section', 'cs_tmc_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'cs_tmc_AdminPageFramework_Form_View___CSS_FieldError', 'cs_tmc_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('cs_tmc_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new cs_tmc_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new cs_tmc_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
