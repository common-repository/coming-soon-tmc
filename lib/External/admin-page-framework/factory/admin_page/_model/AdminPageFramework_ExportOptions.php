...
abstract class cs_tmc_AdminPageFramework_CustomSubmitFields extends cs_tmc_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class cs_tmc_AdminPageFramework_ExportOptions extends cs_tmc_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo cs_tmc_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
