...
class cs_tmc_AdminPageFramework_Property_admin_page extends cs_tmc_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'cs-tmc') {
        ...
        $GLOBALS['acs_tmc_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('acs_tmc_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['acs_tmc_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
