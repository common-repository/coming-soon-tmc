...
abstract class cs_tmc_AdminPageFramework_Model__FormSubmission_Base extends cs_tmc_AdminPageFramework_FrameworkUtility {
...
class cs_tmc_AdminPageFramework_Model__FormSubmission extends cs_tmc_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new cs_tmc_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new cs_tmc_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
