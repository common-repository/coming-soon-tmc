...
class cs_tmc_AdminPageFramework_Model__FormSubmission__Validator_Base extends cs_tmc_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class cs_tmc_AdminPageFramework_Model__FormSubmission__Validator extends cs_tmc_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Link', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Import', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Export', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new cs_tmc_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
