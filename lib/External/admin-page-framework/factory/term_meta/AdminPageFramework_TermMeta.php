...
abstract class cs_tmc_AdminPageFramework_TermMeta_Router extends cs_tmc_AdminPageFramework_TaxonomyField_Controller {
}
abstract class cs_tmc_AdminPageFramework_TermMeta_Model extends cs_tmc_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new cs_tmc_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class cs_tmc_AdminPageFramework_TermMeta_View extends cs_tmc_AdminPageFramework_TermMeta_Model {
...
abstract class cs_tmc_AdminPageFramework_TermMeta_Controller extends cs_tmc_AdminPageFramework_TermMeta_View {
}
abstract class cs_tmc_AdminPageFramework_TermMeta extends cs_tmc_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'cs-tmc') {
