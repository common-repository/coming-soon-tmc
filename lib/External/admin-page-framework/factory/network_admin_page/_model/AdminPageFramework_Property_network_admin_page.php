...
class cs_tmc_AdminPageFramework_Property_network_admin_page extends cs_tmc_AdminPageFramework_Property_admin_page {
    ...
    protected function _getOptions() {
        return $this->addAndApplyFilter($this->getElement($GLOBALS, array('acs_tmc_AdminPageFramework', 'aPageClasses', $this->sClassName)), 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
