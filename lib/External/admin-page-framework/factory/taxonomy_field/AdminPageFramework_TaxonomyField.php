...
abstract class cs_tmc_AdminPageFramework_TaxonomyField_Router extends cs_tmc_AdminPageFramework_Factory {
...
abstract class cs_tmc_AdminPageFramework_TaxonomyField_Model extends cs_tmc_AdminPageFramework_TaxonomyField_Router {
...
abstract class cs_tmc_AdminPageFramework_TaxonomyField_View extends cs_tmc_AdminPageFramework_TaxonomyField_Model {
...
abstract class cs_tmc_AdminPageFramework_TaxonomyField_Controller extends cs_tmc_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class cs_tmc_AdminPageFramework_TaxonomyField extends cs_tmc_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'cs-tmc') {
